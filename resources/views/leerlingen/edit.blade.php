<x-layouts::app :title="$title">
    <div class="flex h-full w-full flex-1 flex-col gap-6 rounded-xl p-4 sm:p-6 lg:p-8">
        <div>
            ...
            <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Werk de gegevens van deze leerling bij.</p>
        </div>
        ...
        <form method="POST" action="{{ route('leerlingen.update', $leerling->LeerlingId) }}" class="max-w-4xl rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            @csrf
            @method('PUT')
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" id="voornaam" name="voornaam" value="{{ old('voornaam', $leerling->Voornaam) }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>

                <div>
                    <label for="achternaam" class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">Achternaam</label>
                    <input type="text" id="achternaam" name="achternaam" value="{{ old('achternaam', $leerling->Achternaam) }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="telefoon" name="telefoon" value="{{ old('telefoon', $leerling->Telefoon) }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>

                <div>
                    <label for="email" class="mb-2 block text-sm font-medium text-zinc-700 dark:text-zinc-200">E-mail</label>
                    <input type="email" id="email" name="email" value="{{ old('email', $leerling->Email) }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="woonplaats" name="woonplaats" value="{{ old('woonplaats', $leerling->Woonplaats) }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
                ...
                <div>
                    ...
                    <select id="instructeur_id" name="instructeur_id" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                        ...
                        @foreach ($instructeurs as $instructeur)
                            <option value="{{ $instructeur->InstructeurId }}" @selected((string) old('instructeur_id', $leerling->InstructeurId) === (string) $instructeur->InstructeurId)>
                ...
                <div>
                    ...
                    <select id="lespakket_id" name="lespakket_id" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                        ...
                        @foreach ($lespakketten as $lespakket)
                            <option value="{{ $lespakket->LespakketId }}" @selected((string) old('lespakket_id', $leerling->LespakketId) === (string) $lespakket->LespakketId)>
                                {{ $lespakket->Naam }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" min="0" step="1" id="les_tegoed" name="les_tegoed" value="{{ old('les_tegoed', $leerling->LesTegoed) }}" required class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">
                </div>
                ...
                <div class="flex items-center gap-3 rounded-xl border border-zinc-200 px-4 py-3 dark:border-zinc-800">
                    ...
                    <input type="checkbox" id="is_actief" name="is_actief" value="1" @checked((string) old('is_actief', $leerling->IsActief) === '1') class="h-4 w-4 rounded border-zinc-300 text-zinc-900 focus:ring-zinc-900">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="opmerking" name="opmerking" rows="4" maxlength="255" class="block w-full rounded-xl border-zinc-300 bg-white px-4 py-2.5 text-zinc-900 shadow-sm focus:border-zinc-900 focus:ring-zinc-900 dark:border-zinc-700 dark:bg-zinc-950 dark:text-zinc-100">{{ old('opmerking', $leerling->Opmerking) }}</textarea>
                </div>
            </div>
